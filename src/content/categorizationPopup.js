...
function showResurfaceCategorizationPopup(resource, classification) {
  ...
  function render() {
    container.innerHTML = `
      ...
      ">
        <!-- Success Header (since we skip the toast) -->
        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 14px; padding-bottom: 12px; border-bottom: 1px solid #F5A62315;">
          <div style="width: 20px; height: 20px; background: #F5A623; border-radius: 6px; display: flex; align-items: center; justify-content: center;">
        ...
        <div style="display: flex; gap: 8px; margin-top: 14px;">
          <button id="rs-cat-confirm" style="flex: 1.5; background: #F5A623; color: white; border: none; height: 34px; border-radius: 8px; font-size: 12px; font-weight: 800; cursor: pointer; transition: transform 0.1s;">
            Confirm
          </button>
          <button id="rs-cat-dismiss" style="flex: 1; background: white; color: #6B6B6B; border: 1px solid #E5DFC8; height: 34px; border-radius: 8px; font-size: 12px; font-weight: 600; cursor: pointer;">
            Skip
          </button>
        </div>
      </div>
